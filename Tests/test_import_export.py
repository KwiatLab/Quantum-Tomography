...
class Test_Import_Export(unittest.TestCase):
    def test_eval(self):
        ...
        for Tomo_Object in [Tomo_Object_1, Tomo_Object_2, Tomo_Object_3]:
            ...
            tests.assert_array_equal(
                Tomo_Object.last_input, Tomo_Object_copy.last_input
            )
            tests.assert_array_equal(
                Tomo_Object.intensities, Tomo_Object_copy.intensities
            )
            ...
            self.assertEqual(
                Tomo_Object.last_intensity, Tomo_Object_copy.last_intensity
            )
    ...
    def test_video_example(self):
        q = qLib.Tomography()
        [rho_approx, intensity, fval] = q.importEval(
            r"../ExampleFiles/pythoneval_video.txt"
        )
