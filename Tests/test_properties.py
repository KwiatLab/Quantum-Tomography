...
class Test_Properties(unittest.TestCase):
    ...
    def test_purity(self):
        ...
        for qDim in [1, 2, 3, 4]:
            ...
            # Tests
            self.assertEqual(any(puritys < 0.95), False)  # Purities of random pure states should be 1
    ...
    def test_concurrence(self):
        ...
        # Tests
        self.assertEqual(any(cons < 0.95), False)  # Concurrence of random bell states should be 1
        self.assertEqual(any(negs < 0.95), False)  # Negativity of random bell states should be 1
    ...
    def test_entropy(self):
        for qDim in [1, 2, 3, 4]:
            ...
            # Tests
            self.assertEqual(any(entrops > 0.05), False)  # Entropy of pure states should be 0
