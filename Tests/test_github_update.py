...
#    1 Qubit
def test_N1_e0_a0_d0_c0_b0_dr0():
    numTotalErrors = 0
    ...
    for t in Tomographys:
        ...
        if Original_Purity < 0:
            numTotalErrors += 1
    assert numTotalErrors == 0


def test_N1_e3_a0_d0_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N1_e0_a0_d1_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N1_e0_a0_d0_c1_b0_dr0():
    numTotalErrors = 0
...
def test_N1_e0_a0_d0_c0_b0_dr1():
    numTotalErrors = 0
...
# 2 qubits
def test_N2_e0_a0_d0_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N2_e3_a0_d0_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N2_e0_a1_d0_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N2_e0_a0_d1_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N2_e0_a0_d0_c1_b0_dr0():
    numTotalErrors = 0
...
def test_N2_e0_a0_d0_c0_b1_dr0():
    numTotalErrors = 0
...
def test_N2_e0_a0_d0_c0_b0_dr1():
    numTotalErrors = 0
...
# 3 qubits
def test_N3_e0_a0_d0_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N3_e3_a0_d0_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N3_e0_a1_d0_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N3_e0_a0_d1_c0_b0_dr0():
    numTotalErrors = 0
...
def test_N3_e0_a0_d0_c1_b0_dr0():
    numTotalErrors = 0
...
def test_N3_e0_a0_d0_c0_b1_dr0():
    numTotalErrors = 0
...
def test_N3_e0_a0_d0_c0_b0_dr1():
    numTotalErrors = 0
